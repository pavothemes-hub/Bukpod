# Local Translate Guide

## 1. Installing and Activating of Loco Translate

In order to install plugin, simply go to **Plugins -> Add New** and search for _Loco Translate_.
...
_**Warning:** 3 files over 100 KB have been skipped. (Largest is xxx KB). Check all strings are present before saving._
...
{% hint style="info" %}
_**Remember**: In order to keep your new translation files remain safe from the theme update, I recommend that you select **System** option._
{% endhint %}
